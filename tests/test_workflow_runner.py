...
class TestDefaultInputExtraction:
    ...
    def test_extract_simple_default(self, sample_workflow):
        ...
        assert "commands" in defaults
        assert defaults["commands"] == "hostname\ndate"
...
class TestWorkflowLoading:
    ...
    def test_workflow_has_batch_submit_job(self, workflow_runner: WorkflowRunner):
        """Test that workflow has the batch_submit job."""
        workflow = workflow_runner.load_workflow()
        assert "batch_submit" in workflow["jobs"]
    ...
    def test_workflow_has_required_inputs(self, workflow_runner: WorkflowRunner):
        ...
        assert "commands" in inputs
        assert "rundir" in inputs
